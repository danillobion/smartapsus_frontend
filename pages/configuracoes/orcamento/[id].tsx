...
const estrutura = {
  ...
  cadastro: {
    campos: [ // colunas da tabela
      [
        { nome: "ano", chave: "ano", tipo: "number", mensagem: "Digite o ano", obrigatorio: true, selectOptions: null, bloqueado: false, oculto: false },
        { nome: "valor", chave: "valor", tipo: "number", mensagem: "Digite o valor", obrigatorio: true, selectOptions: null, bloqueado: false, oculto: false },
      ],
      [
        { nome: "unidade", chave: "unidade", tipo: "text", mensagem: "Digite a unidade", obrigatorio: true, selectOptions: null, bloqueado: false, oculto: false },
        { nome: "detalhe do oçamento", chave: "detalhesOrcamento", tipo: "text", mensagem: "Digite o detalhe do orçamento", obrigatorio: true, selectOptions: null, bloqueado: false, oculto: false },
      ]
    ],
    acoes: [
...
const Editar = () => {
  ...
  const [unidadeAPS, setUnidadeAPS] = useState(null);
  ...
  const salvarRegistro = async (item) => {
    const confirmacao = await Swal.fire({
      title: "Você deseja salvar o orçamento?",
      icon: "warning",
  ...
  const unidadeAPSRegistro = async (item) => {
    try {
      const body = {
        metodo: 'get',
        uri: '/unidadeAPS',
      ...
      if (response.data.errors) {
        ...
        unidadeAPSRegistro(response.data.content);
      }
    } catch (error) {
