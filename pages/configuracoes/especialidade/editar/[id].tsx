...
const Editar = () => {
  ...
  const salvarRegistro = async (item) => {
    ...
    const confirmacao = await Swal.fire({
      title: "Você deseja salvar a especialidade?",
      icon: "warning",
  ...
  const estrutura = {
    ...
    cabecalho: { // cabecalho da pagina
      ...
      migalha: [
        ...
        { nome: 'Especialidades', link: '/configuracoes/especialidade' },
      ]
    },
    ...
    cadastro: {
      campos: [ // colunas da tabela
        [
          { nome: "nome", chave: "nome", tipo: "text", mensagem: "Digite o nome da especialidade", obrigatorio: true, selectOptions: null, bloqueado: false, oculto: false },
          { nome: "codigo", chave: "codigo", tipo: "text", mensagem: "Digite o código", obrigatorio: true, selectOptions: null, bloqueado: false, oculto: false },
        ],
      ],
      acoes: [
